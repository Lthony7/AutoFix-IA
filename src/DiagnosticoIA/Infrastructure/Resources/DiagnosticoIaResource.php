...
class DiagnosticoIaResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'diagnosticoDetalle' => $this->diagnostico_detalle,
            'posiblesCausas' => $this->posibles_causas,
            'accionesRecomendadas' => $this->acciones_recomendadas,
            'especialidadRecomendada' => $this->especialidad_recomendada,
            'mecanicosSugeridos' => $this->mecanicos_sugeridos,
