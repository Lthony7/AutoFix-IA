...
const handleSubmit = () => {
  ...
  router.put(route('mecanicos.update', mecanico.id), {
    ...state,
    ...
    <template #body>
      <div class="flex w-full min-w-0 flex-col gap-4">
        ...
        <ModulePanel title="Datos del mecánico" class="w-full">
          <form id="form-editar-mecanico" class="grid w-full grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3" @submit.prevent="handleSubmit">
